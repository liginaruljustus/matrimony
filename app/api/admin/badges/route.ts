...
import { UserModel, ProfileModel, PaymentModel, ReportModel } from "@/lib/models";
...
export async function GET() {
  ...
  const [newUsers, pendingProfiles, pendingVerification, openReports, pendingPayments] =
    await Promise.all([
  ...
  return Response.json({ newUsers, pendingProfiles, pendingVerification, openReports, pendingPayments });
}
